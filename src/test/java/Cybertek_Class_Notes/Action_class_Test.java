...
public class Action_class_Test {
    ...
    2 - JavascriptExecutor interface
      ...
      ----------------------------------------------------------------
      Selenium will not have any problen to find element, unless element is not int the dom. Even if it is invisible.
     https://demos.telerik.com/kendo-ui/dragdrop/index   --> for drag and drop practice.
    ...
    public void hoverTest3(){
        ...
        action.moveToElement(enabledElement).
                ...
                build().
                perform();
        MyWaitTime.wait(2);//JUST FOR DEMO
    }
    @Test
